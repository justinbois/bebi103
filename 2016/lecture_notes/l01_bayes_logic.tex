...
Statistical inference is the business of quantifying \textit{how
...
We will learn use some frequentist approaches in class, especially when we do \textit{nonparametric} methods, but we will
